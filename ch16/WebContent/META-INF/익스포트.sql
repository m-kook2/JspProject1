  ...
  CREATE TABLE "J20200701"."COMM" 
   (	"C_IDX" NUMBER NOT NULL ENABLE, 
	...
	"OVERLAP" VARCHAR2(4000 BYTE), 
	 CONSTRAINT "PK_COMM" PRIMARY KEY ("C_IDX")
...
SET DEFINE OFF;
Insert into J20200701.COMM (C_IDX,ID,C_CONTENT,C_SYMPATHY,C_UNSYMPATHY,C_GRADE,C_DATE,DEL_YN,M_IDX,STEP,DEP,OVERLAP) values (3,'admin','7번째 영화의 세번째 댓글',1,0,6,to_date('20/08/06','RR/MM/DD'),'N',7,0,0,'admin');
...
Insert into J20200701.COMM (C_IDX,ID,C_CONTENT,C_SYMPATHY,C_UNSYMPATHY,C_GRADE,C_DATE,DEL_YN,M_IDX,STEP,DEP,OVERLAP) values (6,'admin','7번째 영화의 세번째 댓글의 세번째 답글',0,0,null,to_date('20/08/06','RR/MM/DD'),'N',7,3,1,null);
