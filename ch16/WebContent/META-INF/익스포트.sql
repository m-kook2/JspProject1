...
--------------------------------------------------------
DROP TABLE "J20200701"."BOARD";
DROP TABLE "J20200701"."BOOK_MIND";
DROP TABLE "J20200701"."COMM";
DROP TABLE "J20200701"."CS";
DROP TABLE "J20200701"."MEMBER";
DROP TABLE "J20200701"."MOVIE_INFO";
DROP TABLE "J20200701"."REVIEW";
DROP TABLE "J20200701"."SUR";
...
/
--------------------------------------------------------
--  DDL for Procedure SUR_ARRANGE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "J20200701"."SUR_ARRANGE" (
  p_s_idx in sur.s_idx%TYPE,
  p_op_i in NUMBER
)
IS
  v_s_op sur.s_op1%TYPE;
BEGIN
  DBMS_OUTPUT.ENABLE;
  DBMS_OUTPUT.PUT_LINE('table sur arrangement');
  ...
  IF  (SELECT  s_op1
       FROM   SUR
       WHERE  s_idx = p_s_idx) IS null THEN 
...
/
--------------------------------------------------------
--  DDL for Procedure SUR_MINUS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "J20200701"."SUR_MINUS" (
  p_start in sur.s_idx%type
)
IS
BEGIN
  DBMS_OUTPUT.ENABLE;
  DBMS_OUTPUT.PUT_LINE('table sur decrement');
