		...
		<input type="hidden" name="m_idx" value="${m_idx}">
			...
			<c:choose>
				<c:when test="${not empty mt.m_photo}">
					${mt.m_photo}<a href="movieDelete.do?m_photo=${mt.m_photo}&gubun=photo&m_idx=${mt.m_idx}">삭제하기</a><hr>
			...
			<c:choose>
				<c:when test="${not empty mt.m_poster}">
					${mt.m_poster}<a href="movieDelete.do?m_poster=${mt.m_poster}&gubun=poster&m_idx=${mt.m_idx}">삭제하기</a><hr>
